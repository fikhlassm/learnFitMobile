...
class _PomodoroSessionPageState extends State<PomodoroSessionPage>
  ...
  void initState() {
    ...
    _circleAnimController = AnimationController(
      vsync: this,
      duration: const Duration(seconds: _workDuration),
    );
  }
  ...
  void _startStop() {
    if (_isRunning) {
      ...
      _circleAnimController.forward(
        from: 1 - (_remainingSeconds / _workDuration),
      );
        ...
        children: [
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    ...
                    valueColor:
                        const AlwaysStoppedAnimation<Color>(Color(0xFFE8E8E8)),
                  ),
                ),
                // Progress circle
                SizedBox(
                  ...
                  height: 180,
                  child: CircularProgressIndicator(
                    value: _remainingSeconds / _workDuration,
                    strokeWidth: 8,
                    backgroundColor: Colors.transparent,
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(
                _isRunning ? 'Pause Sesi' : 'Mulai Sesi',
                style: const TextStyle(
                  fontSize: 15,
              ...
              children: [
                Row(
                  ...
                  children: List.generate(_totalSessions, (i) {
                    return Container(
                      width: i < _currentSession ? 24 : 20,
                      height: 8,
                      margin: const EdgeInsets.symmetric(horizontal: 3),
                      decoration: BoxDecoration(
                        color: i < _currentSession
