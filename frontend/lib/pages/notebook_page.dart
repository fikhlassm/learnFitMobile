...
class NotebookPage extends StatefulWidget {
  ...
  @override
  State<NotebookPage> createState() =>
      _NotebookPageState();
}

class _NotebookPageState
    extends State<NotebookPage> {
  ...
  static Widget _sessionPageFor(
    ...
    switch (method) {
      ...
      case 'Feynman Technique':
        return FeynmanSessionPage(
          topicTitle: title,
        );

      case 'Blurting':
        return BlurtingSessionPage(
          topicTitle: title,
        );
